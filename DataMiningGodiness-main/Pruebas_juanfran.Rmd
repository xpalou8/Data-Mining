...
#data_no_outlier["quartile"] <- cut(data_no_outlier$salary_in_usd, breaks=c(0, 50000, 75000, 100000, 125000, 150000, 200000, Inf), labels=paste("Salary", 1:7, #sep=""))
#data_no_outlier["quartile"] <- cut(data_no_outlier$salary_in_usd, breaks=c(0, 75000, 125000, 175000, Inf), labels=paste("Salary", 1:4, sep=""))
...
printALL(rf)
```
Try and get datasets with binary classification on quartile column.
```{r}
